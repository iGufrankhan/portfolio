...
// Reusable card with blue hover effect
const HoverCard = ({ children, onClick }) => (
  <motion.div
    whileHover={{
      scale: 1.02,
      y: -5,
    ...
    onClick={onClick}
    className="group cursor-pointer relative bg-white dark:bg-dark/40 backdrop-blur-xl 
               border border-white/10 rounded-xl shadow-lg p-6 mb-10 
               transition-all duration-300"
  >
    {children}

    {/* BLUE hover effect FIXED */}
  ...
  return (
    <div className="container mx-auto px-6 py-20">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h2 className="font-semibold text-lg hover:text-blue-500 transition-colors">Machine Learning – GeeksforGeeks</h2>
              <p className="text-sm mt-2">26-week ML, DL, NLP, Data Analysis program.</p>
            </div>
          </div>
        </HoverCard>
        ...
        >
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h2 className="font-semibold text-lg hover:text-blue-500 transition-colors">DBMS – Scaler</h2>
        ...
        >
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h2 className="font-semibold text-lg hover:text-blue-500 transition-colors">Problem Solving – HackerRank</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        {/* CodeChef */}
        <HoverCard onClick={() => window.open("https://www.codechef.com/users/codewithgufran", "_blank")}>
          <div className="flex items-start space-x-4">
        ...
        {/* Codeforces */}
        <HoverCard onClick={() => window.open("https://codeforces.com/profile/I_am_BackTrack", "_blank")}>
          <div className="flex items-start space-x-4">
        ...
        {/* LeetCode */}
        <HoverCard onClick={() => window.open("https://leetcode.com/u/I_am_BackTrack/", "_blank")}>
          <div className="flex items-start space-x-4">
        ...
        {/* GFG */}
        <HoverCard onClick={() => window.open("https://www.geeksforgeeks.org/profile/iambacktrack", "_blank")}>
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">Rank 24 (Institute)</p>
        ...
        <HoverCard>
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-sm mt-2">CGPA: <strong>8.9</strong></p>
            </div>
          </div>
        </HoverCard>
      </div>
